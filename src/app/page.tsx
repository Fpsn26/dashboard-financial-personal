...
export default function Page() {
  ...
  const [chartType] = useState<TypeTransaction | "all">("all");
  ...
  return (
    <div
      className={`min-h-screen overflow-x-hidden transition-colors duration-300 ${
        theme === "dark" ? "bg-[rgb(27,38,44)]" : "bg-gray-50"
      }`}
    >
      <ChangelogModal />
      ...
      >
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-center md:text-left min-w-0">
            <h1
              className={`text-xl md:text-2xl font-bold truncate transition-colors ${
                theme === "dark" ? "text-[rgb(187,225,250)]" : "text-gray-900"
              }`}
            >
              Financial Dashboard
            </h1>
            <p
              className={`text-xs transition-colors ${
                theme === "dark" ? "text-[rgb(187,225,250)]/60" : "text-gray-600"
              }`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:items-start">
          <div className="lg:col-span-4 space-y-6 order-2 lg:order-1 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3">
                  ...
                  <div className="min-w-0">
                    <p
                      className={`text-[10px] uppercase font-bold tracking-wider ${
                        theme === "dark" ? "text-emerald-300/60" : "text-emerald-700"
                      }`}
                    >
                      Receitas
                    </p>
              ...
              <div
                className={`sm:col-span-2 lg:col-span-1 p-5 rounded-xl border transition-colors ${
                  total >= 0
                    ? theme === "dark"
          ...
          <div className="lg:col-span-8 order-1 lg:order-2 min-w-0">
            <div
              className={`flex flex-col h-175 max-h-127 rounded-xl border transition-colors ${
                theme === "dark" ? "glass-card" : "bg-white border-gray-200"
              }`}
            >
              <div
                className={`p-4 border-b flex flex-col sm:flex-row gap-4 justify-between items-center transition-colors ${
                  theme === "dark"
              ...
              >
                <div
                  className={`flex gap-1 p-1 rounded-xl border w-full sm:w-auto shrink-0 ${
                    theme === "dark"
                ...
                >
                  <button
                    ...
                    className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm transition-all ${
                      view === "list"
                        ? theme === "dark"
